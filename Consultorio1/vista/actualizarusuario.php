			...
			<?php include 'plantillas/nav.php'; ?>
				<article>
					...
					<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
                        ...
                        <input type="text" name="apellidopat" placeholder="Apellido paterno" value="<?php echo $user['apellidopat'];?>"/>
                        <input type="text" name="apellidomat" placeholder="Apellido materno" value="<?php echo $user['apellidomat'];?>"/>
                        <select name="roll">
